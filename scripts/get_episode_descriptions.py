...
def get_tng_episode_refs():
    ...
    #episode_tr = soup.body.table.find_all("tr")[6]
    ...
    for etable in episode_tables:
        ...
        prod_code = etable.find_all(class_='col3')
        air_date = etable.find_all(class_='col4')
        star_date = etable.find_all(class_='col5')
        break
